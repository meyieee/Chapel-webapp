...
const Home = () => {
  const [homeContent, setHomeContent] = useState({
    ...
    description: "Join our vibrant community where every voice counts. Share your experiences, ideas, and suggestions to help shape the future of our student forum."
  });
